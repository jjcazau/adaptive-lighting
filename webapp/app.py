...
app_ui = ui.page_fluid(
    ...
    ui.layout_sidebar(
        ui.sidebar(
            ui.markdown("#### Simulation Controls"),
            ui.tags.small("Adjust these options to see how they change the lighting curves."),
            ui.markdown("**Modes**"),
            ui.input_switch(
                "sleep_mode",
                "Preview sleep mode",
            ...
            ui.tags.small("Show how brightness and color behave after sleep is enabled."),
            ui.input_switch(
                "adapt_until_sleep",
                "Keep adapting until sleep starts",
                value=False,
            ),
            ui.tags.small(
                "When enabled, the lights continue to follow daytime curves until sleep is active.",
            ),
            ui.tags.hr(),
            ui.markdown("**Daytime Brightness**"),
            ui.input_slider(
                "min_brightness",
                "Minimum daytime brightness",
                1,
                100,
                30,
                post="%",
            ...
            ui.tags.small("Define the dimmest and brightest levels used outside of sleep mode."),
            ui.tags.hr(),
            ui.markdown("**Color Temperature**"),
            ui.input_numeric(
                "min_color_temp",
                "Warmest color temperature (K)",
                2000,
            ),
            ui.input_numeric(
                "max_color_temp",
                "Coolest color temperature (K)",
                6666,
            ),
            ui.tags.small("Use a lower value for a warmer feel and a higher value for cooler daylight."),
            ui.tags.hr(),
            ui.markdown("**Sleep Lighting**"),
            ui.input_slider(
                "sleep_brightness",
                "Brightness during sleep",
                1,
                100,
                1,
                post="%",
            ...
            ui.input_radio_buttons(
                ...
                "Sleep lighting uses",
                [("RGB color", "rgb_color"), ("Color temperature", "color_temp")],
            ),
            ui.input_numeric(
                "sleep_color_temp",
                "Sleep color temperature (K)",
                2000,
            ),
            ui.input_text(
                "sleep_rgb_color",
                "Sleep RGB color (R,G,B)",
                "255,0,0",
            ),
            ui.tags.small(
                "Enter a comma separated RGB value, e.g. 255,128,64, used when RGB color is selected.",
            ),
            ui.tags.hr(),
            ui.markdown("**Transition Timing**"),
            ui.input_slider(
                "brightness_mode_time_dark",
                "Seconds to settle after sunset",
                1,
                5 * SEC_PER_HR,
                3 * SEC_PER_HR,
                post=" sec",
            ...
            ui.input_slider(
                ...
                "Seconds to ramp up before sunrise",
                1,
                5 * SEC_PER_HR,
                0.5 * SEC_PER_HR,
                post=" sec",
            ...
            ui.tags.hr(),
            ui.markdown("**Custom Sun Schedule**"),
            ui.input_slider(
                "sunrise_time",
                "Sunrise time (hours)",
                0,
